...
async def send_welcome(message: types.Message):
    ...
    photo_file_id = "AgACAgIAAxkBAAEglXRpZpM3M5Bz3WwyXpjK-BxXnF0xtAAChhNrG7yrMUvHVNR4Ze7jmgEAAwIAA3kAAzgE"

    caption_text = (
        f"<b><i>Привет! {html.bold(message.from_user.first_name)}, это бот-помощник команды NPAuto</i></b> 👋 \n\n"
        "Совсем скоро <b><i>МЫ проведём</i></b> свой первый масштабный <b>промо-розыгрыш!</b> 🚗 🎁 \n\n"
        "Победитель станет обладателем легендарной <b><i>Audi A4</i></b>\n\n"
        "<b><i>Но это ещё не всё!!!</i></b> Мы подготовили для\n"
        ...
        "💫 <b><i>10 покупателей получат - </i></b>наклейку,\n"
        "которая даёт право участвовать в нашем\n"
...
async def send_rules(callback: types.CallbackQuery):
    ...
    caption_text = (
        ...
        f"<i>Всего в продаже 888 наклеек, купив которые, "
        "Вы сможете участвовать в акции.</i> 😎\n\n"
        "<b>*Промо-розыгрыш проводится до 17.07.2025.</b>\n\n"
